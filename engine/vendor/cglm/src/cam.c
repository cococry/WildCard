...
CGLM_EXPORT
inline void glmc_perspective_default(float aspect, mat4 dest) {
    glm_perspective_default(aspect, dest);
}

CGLM_EXPORT
inline void glmc_perspective_resize(float aspect, mat4 proj) {
    glm_perspective_resize(aspect, proj);
}

CGLM_EXPORT
inline void glmc_lookat(vec3 eye, vec3 center, vec3 up, mat4 dest) {
    glm_lookat(eye, center, up, dest);
}

CGLM_EXPORT
inline void glmc_look(vec3 eye, vec3 dir, vec3 up, mat4 dest) {
    glm_look(eye, dir, up, dest);
}

CGLM_EXPORT
inline void glmc_look_anyup(vec3 eye, vec3 dir, mat4 dest) {
    glm_look_anyup(eye, dir, dest);
}

CGLM_EXPORT
inline void glmc_persp_decomp(mat4 proj,
...
CGLM_EXPORT
inline void glmc_persp_decompv(mat4 proj, float dest[6]) {
    glm_persp_decompv(proj, dest);
}

CGLM_EXPORT
inline void glmc_persp_decomp_x(mat4 proj,
                                float* __restrict left,
                                float* __restrict right) {
...
CGLM_EXPORT
inline void glmc_persp_decomp_y(mat4 proj,
                                float* __restrict top,
                                float* __restrict bottom) {
...
CGLM_EXPORT
inline void glmc_persp_decomp_z(mat4 proj,
                                float* __restrict nearZ,
                                float* __restrict farZ) {
...
CGLM_EXPORT
inline void glmc_persp_decomp_far(mat4 proj, float* __restrict farZ) {
    glm_persp_decomp_far(proj, farZ);
}

CGLM_EXPORT
inline void glmc_persp_decomp_near(mat4 proj, float* __restrict nearZ) {
...
CGLM_EXPORT
inline float glmc_persp_aspect(mat4 proj) {
    return glm_persp_aspect(proj);
}

CGLM_EXPORT
inline void glmc_persp_sizes(mat4 proj, float fovy, vec4 dest) {
